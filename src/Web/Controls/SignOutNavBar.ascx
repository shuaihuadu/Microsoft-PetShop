<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SignOutNavBar.ascx.cs" Inherits="PetShop.Web.Controls.SignOutNavBar" enableViewState="False" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<!-- top bar -->
...
<table cellspacing="0" cellpadding="0" width="100%" height="38" background="Images/top_stripe2.gif" border="0">
	<form id="search" method="get" action="Search.aspx">
		<TBODY>
			<tr>
				<td><img src="../Images/liz_1.gif" id="lizard1" runat="server"></td>
				<td align="right" nowrap>
					<font class="menuOrange"><span><a href="SignIn.aspx" class="menuOrange">
...
<img src="../Images/liz_4.gif" id="lizard4" runat="server">
